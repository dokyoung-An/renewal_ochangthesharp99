...
// Filename: ?? VR 1??? -????15.ggsk
// Generated 2024-04-09T15:52:18
...
function pano2vrSkin(player,base) {
	...
	this.addSkin=function() {
		...
		me.__41.appendChild(me._image_1);
		me.__12.appendChild(me.__41);
		...
		me.__39.logicBlock_backgroundcolor = function() {
			...
			if (me.__39.ggCurrentLogicStateBackgroundColor != newLogicStateBackgroundColor) {
				...
				me.__39.style.transition='background-color 0s';
				if (me.__39.ggCurrentLogicStateBackgroundColor == 0) {
					me.__39.style.backgroundColor="rgba(2,109,243,1)";
				}
				else {
					me.__39.style.backgroundColor="rgba(255,255,255,0)";
				}
			}
		}
		...
		me.__37.logicBlock_backgroundcolor = function() {
			...
			if (me.__37.ggCurrentLogicStateBackgroundColor != newLogicStateBackgroundColor) {
				...
				me.__37.style.transition='background-color 0s';
				if (me.__37.ggCurrentLogicStateBackgroundColor == 0) {
					me.__37.style.backgroundColor="rgba(2,109,243,1)";
				}
				else {
					me.__37.style.backgroundColor="rgba(255,255,255,0)";
				}
			}
		}
		...
		me.__35.logicBlock_backgroundcolor = function() {
			...
			if (me.__35.ggCurrentLogicStateBackgroundColor != newLogicStateBackgroundColor) {
				...
				if (me.__35.ggCurrentLogicStateBackgroundColor == 0) {
					me.__35.style.backgroundColor="rgba(2,109,243,1)";
				}
				else {
		...
		me.__33.logicBlock_backgroundcolor = function() {
			...
			if (me.__33.ggCurrentLogicStateBackgroundColor != newLogicStateBackgroundColor) {
				...
				if (me.__33.ggCurrentLogicStateBackgroundColor == 0) {
					me.__33.style.backgroundColor="rgba(2,109,243,1)";
				}
				else {
					me.__33.style.backgroundColor="rgba(255,255,255,0)";
				}
			}
		}
		...
		me.__27.logicBlock_backgroundcolor = function() {
			...
			if (me.__27.ggCurrentLogicStateBackgroundColor != newLogicStateBackgroundColor) {
				...
				if (me.__27.ggCurrentLogicStateBackgroundColor == 0) {
					me.__27.style.backgroundColor="rgba(2,109,243,1)";
				}
				else {
		...
		elVertScrollBg.setAttribute('style', 'position: absolute; right: 0px; top: 0px; visibility: hidden; width: 5px; height: 280px; background-color: rgba(128,128,128,1); pointer-events: auto;');
		elVertScrollBg.className='ggskin ggskin_scrollarea_vscrollbg';
		elVertScrollFg = me._scrollarea_1__vertScrollFg = document.createElement('div');
		elVertScrollBg.appendChild(elVertScrollFg);
		elVertScrollFg.setAttribute('style', 'position: absolute; left: 0px; top: 0px; visibility: hidden; width: 5px; height: 280px; background-color: rgba(192,192,192,1); pointer-events: auto;');
		...
		me._m20.logicBlock_backgroundcolor = function() {
			var newLogicStateBackgroundColor;
			if (
				((me.ggUserdata.tags.indexOf("\uc695\uc2e4") != -1))
			)
			...
			if (me._m20.ggCurrentLogicStateBackgroundColor != newLogicStateBackgroundColor) {
				me._m20.ggCurrentLogicStateBackgroundColor = newLogicStateBackgroundColor;
				me._m20.style.transition='background-color 0s';
				if (me._m20.ggCurrentLogicStateBackgroundColor == 0) {
					me._m20.style.backgroundColor="rgba(2,109,243,1)";
				}
				else {
					me._m20.style.backgroundColor="rgba(255,255,255,0)";
				}
			}
		}
		me._m20.logicBlock_backgroundcolor();
		me._m20.ggUpdatePosition=function (useTransition) {
		}
		el=me._m21=document.createElement('div');
		el.isDragging = function() {
			let scrollerParent = me._m21;
			while ((scrollerParent = scrollerParent.parentNode) != null) {
				if (scrollerParent.hasOwnProperty('ggIsDragging') && scrollerParent.ggIsDragging == true) return true;
			}
			return false;
		}
		els=me._m21__text=document.createElement('div');
		el.className='ggskin ggskin_textdiv';
		el.ggTextDiv=els;
		el.ggId="\ud604\uad00\ucc3d\uace0-m";
		el.ggDy=0;
		...
		me._m21.onclick=function (e) {
			if (me._m21.isDragging()) return;
			player.openNext("{node15}","");
		}
		me._m21.ggUpdatePosition=function (useTransition) {
		}
		me._m20.appendChild(me._m21);
		me.__m1.appendChild(me._m20);
		el=me._m18=document.createElement('div');
		el.isDragging = function() {
			let scrollerParent = me._m18;
			while ((scrollerParent = scrollerParent.parentNode) != null) {
				if (scrollerParent.hasOwnProperty('ggIsDragging') && scrollerParent.ggIsDragging == true) return true;
			}
			return false;
		...
		me._m18.logicBlock_backgroundcolor = function() {
			var newLogicStateBackgroundColor;
			if (
				((me.ggUserdata.tags.indexOf("\uc695\uc2e4") != -1))
			)
			...
			if (me._m18.ggCurrentLogicStateBackgroundColor != newLogicStateBackgroundColor) {
				me._m18.ggCurrentLogicStateBackgroundColor = newLogicStateBackgroundColor;
				me._m18.style.transition='background-color 0s';
				if (me._m18.ggCurrentLogicStateBackgroundColor == 0) {
					me._m18.style.backgroundColor="rgba(2,109,243,1)";
				}
				else {
					me._m18.style.backgroundColor="rgba(255,255,255,0)";
				}
			}
		}
		me._m18.logicBlock_backgroundcolor();
		me._m18.ggUpdatePosition=function (useTransition) {
		}
		el=me._m19=document.createElement('div');
		el.isDragging = function() {
			let scrollerParent = me._m19;
			while ((scrollerParent = scrollerParent.parentNode) != null) {
				if (scrollerParent.hasOwnProperty('ggIsDragging') && scrollerParent.ggIsDragging == true) return true;
			}
			return false;
		}
		els=me._m19__text=document.createElement('div');
		el.className='ggskin ggskin_textdiv';
		el.ggTextDiv=els;
		el.ggId="\ud604\uad00-m";
		el.ggDy=0;
		...
		me._m19.onclick=function (e) {
			if (me._m19.isDragging()) return;
			player.openNext("{node14}","");
		}
		me._m19.ggUpdatePosition=function (useTransition) {
		}
		me._m18.appendChild(me._m19);
		me.__m1.appendChild(me._m18);
		el=me._m16=document.createElement('div');
		el.isDragging = function() {
			let scrollerParent = me._m16;
			while ((scrollerParent = scrollerParent.parentNode) != null) {
				if (scrollerParent.hasOwnProperty('ggIsDragging') && scrollerParent.ggIsDragging == true) return true;
			}
			return false;
		...
		me._m16.logicBlock_backgroundcolor = function() {
			var newLogicStateBackgroundColor;
			if (
				((me.ggUserdata.tags.indexOf("\uc695\uc2e4") != -1))
			)
			...
			if (me._m16.ggCurrentLogicStateBackgroundColor != newLogicStateBackgroundColor) {
				me._m16.ggCurrentLogicStateBackgroundColor = newLogicStateBackgroundColor;
				me._m16.style.transition='background-color 0s';
				if (me._m16.ggCurrentLogicStateBackgroundColor == 0) {
					me._m16.style.backgroundColor="rgba(2,109,243,1)";
				}
				else {
					me._m16.style.backgroundColor="rgba(255,255,255,0)";
				}
			}
		}
		me._m16.logicBlock_backgroundcolor();
		me._m16.ggUpdatePosition=function (useTransition) {
		}
		el=me._m17=document.createElement('div');
		el.isDragging = function() {
			let scrollerParent = me._m17;
			while ((scrollerParent = scrollerParent.parentNode) != null) {
				if (scrollerParent.hasOwnProperty('ggIsDragging') && scrollerParent.ggIsDragging == true) return true;
			}
			return false;
		}
		els=me._m17__text=document.createElement('div');
		el.className='ggskin ggskin_textdiv';
		el.ggTextDiv=els;
		el.ggId="\uc804\uc2e4-m";
		el.ggDy=0;
		...
		me._m17.onclick=function (e) {
			if (me._m17.isDragging()) return;
			player.openNext("{node7}","");
		}
		me._m17.ggUpdatePosition=function (useTransition) {
		}
		me._m16.appendChild(me._m17);
		me.__m1.appendChild(me._m16);
		...
		me._m14.logicBlock_backgroundcolor = function() {
			var newLogicStateBackgroundColor;
			if (
				((me.ggUserdata.tags.indexOf("\uc695\uc2e4") != -1))
			)
			...
			if (me._m14.ggCurrentLogicStateBackgroundColor != newLogicStateBackgroundColor) {
				me._m14.ggCurrentLogicStateBackgroundColor = newLogicStateBackgroundColor;
				me._m14.style.transition='background-color 0s';
				if (me._m14.ggCurrentLogicStateBackgroundColor == 0) {
					me._m14.style.backgroundColor="rgba(2,109,243,1)";
				}
				else {
					me._m14.style.backgroundColor="rgba(255,255,255,0)";
				}
			}
		}
		me._m14.logicBlock_backgroundcolor();
		me._m14.ggUpdatePosition=function (useTransition) {
		}
		el=me._m15=document.createElement('div');
		el.isDragging = function() {
			let scrollerParent = me._m15;
			while ((scrollerParent = scrollerParent.parentNode) != null) {
				if (scrollerParent.hasOwnProperty('ggIsDragging') && scrollerParent.ggIsDragging == true) return true;
			}
			return false;
		}
		els=me._m15__text=document.createElement('div');
		el.className='ggskin ggskin_textdiv';
		el.ggTextDiv=els;
		el.ggId="\uc695\uc2e4-m";
		el.ggDy=0;
		...
		me._m15.onclick=function (e) {
			if (me._m15.isDragging()) return;
			player.openNext("{node5}","");
		}
		me._m15.ggUpdatePosition=function (useTransition) {
		}
		me._m14.appendChild(me._m15);
		me.__m1.appendChild(me._m14);
		el=me._m12=document.createElement('div');
		el.isDragging = function() {
			let scrollerParent = me._m12;
			while ((scrollerParent = scrollerParent.parentNode) != null) {
				if (scrollerParent.hasOwnProperty('ggIsDragging') && scrollerParent.ggIsDragging == true) return true;
			}
			return false;
		...
		me._m12.logicBlock_backgroundcolor = function() {
			var newLogicStateBackgroundColor;
			if (
				((me.ggUserdata.tags.indexOf("\uc695\uc2e4") != -1))
			)
			...
			if (me._m12.ggCurrentLogicStateBackgroundColor != newLogicStateBackgroundColor) {
				me._m12.ggCurrentLogicStateBackgroundColor = newLogicStateBackgroundColor;
				me._m12.style.transition='background-color 0s';
				if (me._m12.ggCurrentLogicStateBackgroundColor == 0) {
					me._m12.style.backgroundColor="rgba(2,109,243,1)";
				}
				else {
					me._m12.style.backgroundColor="rgba(255,255,255,0)";
				}
			}
		}
		me._m12.logicBlock_backgroundcolor();
		me._m12.ggUpdatePosition=function (useTransition) {
		}
		el=me._m13=document.createElement('div');
		el.isDragging = function() {
			let scrollerParent = me._m13;
			while ((scrollerParent = scrollerParent.parentNode) != null) {
				if (scrollerParent.hasOwnProperty('ggIsDragging') && scrollerParent.ggIsDragging == true) return true;
			}
			return false;
		}
		els=me._m13__text=document.createElement('div');
		el.className='ggskin ggskin_textdiv';
		el.ggTextDiv=els;
		el.ggId="\ub2e4\uc774\ub2dd\ub8f8-m";
		el.ggDy=0;
		...
		me._m7.logicBlock_backgroundcolor = function() {
			var newLogicStateBackgroundColor;
			if (
				((me.ggUserdata.tags.indexOf("\uc8fc\ubc29") != -1))
			)
			...
			if (me._m7.ggCurrentLogicStateBackgroundColor != newLogicStateBackgroundColor) {
				me._m7.ggCurrentLogicStateBackgroundColor = newLogicStateBackgroundColor;
				me._m7.style.transition='background-color 0s';
				if (me._m7.ggCurrentLogicStateBackgroundColor == 0) {
					me._m7.style.backgroundColor="rgba(2,109,243,1)";
				}
				else {
					me._m7.style.backgroundColor="rgba(255,255,255,0)";
				}
			}
		}
		me._m7.logicBlock_backgroundcolor();
		...
		me._scrollarea_1__content.appendChild(me.__m1);
